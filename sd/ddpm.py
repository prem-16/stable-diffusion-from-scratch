...
class DDPMSampler:
    ...
    def set_inference_timesteps(self, num_inference_steps=60):
    ...
    def add_noise(self, original_samples: torch.FloatTensor, timesteps: torch.IntTensor) -> torch.FloatTensor:
          alpha_cumprod = self.aplha_cumprod.to(device=original_samples.device , dtype=original_samples.dtype)
